...
class SigupForm(Form):
    ...
    phoneNumber = StringField(
        'Phone Number', [validators.InputRequired(message='Phone number is required')])
    country = StringField(
        'Country', [validators.InputRequired(message="Country is required")])
...
class ChangePasswordForm(Form):
    ...
    current_password = PasswordField(
        'Current Password', [validators.InputRequired("Enter current password")])
    new_password = PasswordField('New Password', [validators.InputRequired(
        "Enter new password"), validators.EqualTo('cpassword', message='Password must match')])
...
class LoginForm(Form):
    ...
    """
    email = EmailField(
        'Email', [validators.InputRequired('Email field cannot be empty')])
    password = PasswordField(
        'Password', [validators.InputRequired('Password cannot be empty')])
